...
const SideBar = () => {
  ...
  const getNavLinkClass = ({ isActive }) =>
    isActive ? "block p-1 px-4 text-xl rounded bg-blue-500" : "block p-1 px-4 text-xl rounded hover:bg-blue-500";
      ...
      <nav className="h-full flex flex-col gap-5 mr-2 border-slate-700">
        <div className="bg-orange-500 text-gray-100 w-56 h-full flex flex-col">
          ...
          <nav className="flex-1 p-4 overflow-y-auto">
            ...
            <NavLink to="/sales-data" className={getNavLinkClass}>
              Sales transaction
            </NavLink>
            <NavLink to="/purchase-order" className={getNavLinkClass}>
              Purchase Order
            </NavLink>
            <NavLink to="/purchase" className={getNavLinkClass}>
              Purchase transaction
            </NavLink>
            <NavLink to="/expence" className={getNavLinkClass}>
              Expence
            </NavLink>
            <NavLink to="/estimate" className={getNavLinkClass}>
              Estimate
            </NavLink>
